...
extern "C" void onemklSaxpy(syclQueue_t device_queue, int64_t n,
...
extern "C" void onemklDaxpy(syclQueue_t device_queue, int64_t n,
...
extern "C" void onemklCaxpy(syclQueue_t device_queue, int64_t n,
                            float _Complex alpha, const float _Complex *x,
...
extern "C" void onemklZaxpy(syclQueue_t device_queue, int64_t n,
                            double _Complex alpha, const double _Complex *x,
...
extern "C" void onemklDcopy(syclQueue_t device_queue, int64_t n, const double *x,
    ...
    auto status = oneapi::mkl::blas::column_major::copy(device_queue->val, n, x, 
                                                    incx, y, incy);
    status.wait();
}
