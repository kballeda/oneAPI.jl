...
function onemklSgeqrfBatched(device_queue, m, n, aptrs, lda, stride_a, tau, stride_tau, group_count)
    @ccall liboneapi_support.onemklSgeqrfBatched(device_queue::syclQueue_t, m::Int64, n::Int64,
                                                 ...
                                                 tau::ZePtr{Cfloat}, stride_tau::Int64, group_count::Int64)::Cvoid
end

function onemklDgeqrfBatched(device_queue, m, n, aptrs, lda, stride_a, tau, stride_tau, group_count)
    @ccall liboneapi_support.onemklDgeqrfBatched(device_queue::syclQueue_t, m::Int64, n::Int64,
                                                 ...
                                                 tau::ZePtr{Cdouble}, stride_tau::Int64, group_count::Int64)::Cvoid
end
